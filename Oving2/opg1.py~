...
if __name__ == "__main__":
  ...
  k2_padded = padd_kernel(m_padded,k2)

  m_fft = FFT(m_padded)
  k1_fft = FFT(k1_padded)
  k2_fft = FFT(k2_padded)

  G1=pointwise_multiplication(m_fft,k1_fft)
  G2=pointwise_multiplication(m_fft,k2_fft)
  g1 = IFFT(G1)
  g2 = IFFT(G2)
  g1_unpadded = remove_padding(g1)
  g2_unpadded = remove_padding(g2)
  Img1 = matrix_2_image(g1_unpadded)
  Img2 = matrix_2_image(g2_unpadded)
  Img1.save("jelly_highpass.bmp","bmp")
  Img2.save("jelly_lowpass.bmp","bmp")
